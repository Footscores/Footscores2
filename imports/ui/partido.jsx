                ...
                <tr>
                  ...
                  <td className="col-md-4 col-xs-6 matches">
                    <div className="row">
                      ...
                      : (<form>
                        <div className="row">
                          <input className="col-md-2 col-xs-6" type="number" name="homeGoals" onChange={this.setHomeGoals.bind(this)} />
                          <input className="col-md-2 col-xs-6" type="number" name="awayGoals" onChange={this.setAwayGoals.bind(this)} />
                        </div>
                        <div className="row">
